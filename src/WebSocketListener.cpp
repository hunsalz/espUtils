...
void WebSocketListener::onDisconnect(WSEventHandler handler) { _disconnectWSEventHandler = handler; }

void WebSocketListener::onError(WSErrorHandler handler) { _errorWSEventHandler = handler; }

void WebSocketListener::onPong(WSEventHandler handler) { _pongWSEventHandler = handler; }

void WebSocketListener::onTextMessage(WSEventHandler handler) { _textWSEventHandler = handler; }

void WebSocketListener::onBinaryMessage(WSEventHandler handler) { _binaryWSEventHandler = handler; }
